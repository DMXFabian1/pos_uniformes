...
def build_cashier_tab(window: "MainWindow") -> QWidget:
    ...
    window.sale_origin_value_label.setObjectName("readOnlyField")
    ...
    window.sale_qty_spin.setValue(1)
    window.sale_add_button.setText("Agregar sin codigo")
    window.sale_add_button.setObjectName("toolbarSecondaryButton")
    window.sale_add_button.setVisible(True)
    ...
    window.sale_origin_direct_button.setObjectName("toolbarGhostButton")
    window.sale_origin_release_button.setObjectName("toolbarGhostButton")
    ...
    sale_form.addWidget(window.sale_sku_input, 0, 1, 1, 3)
    sale_form.addWidget(window.sale_add_button, 0, 4)
    sale_form.addWidget(QLabel("Pago"), 0, 5)
    sale_form.addWidget(window.sale_payment_combo, 0, 6)
    sale_form.addWidget(window.sale_discount_field_label, 0, 7)
    sale_form.addWidget(window.sale_discount_combo, 0, 8)
    ...
    sale_form.addWidget(window.sale_client_display_label, 1, 4, 1, 5)
    sale_form.addWidget(QLabel("Responsable"), 2, 0)
    sale_form.addWidget(window.sale_origin_value_label, 2, 1, 1, 4)
    sale_form.addWidget(window.sale_origin_direct_button, 2, 5)
    sale_form.addWidget(window.sale_origin_release_button, 2, 6)
    ...
    window.sale_origin_release_button.clicked.connect(window._handle_sale_origin_release)
    ...
    window.sale_cart_table.setColumnCount(4)
    window.sale_cart_table.setHorizontalHeaderLabels(["Cantidad", "Producto", "Precio", "Subtotal"])
    window.sale_cart_table.setObjectName("cashierCartTable")
    window.sale_cart_table.verticalHeader().setVisible(False)
    window.sale_cart_table.verticalHeader().setDefaultSectionSize(48)
