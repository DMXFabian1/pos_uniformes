...
def build_cashier_tab(window: "MainWindow") -> QWidget:
    ...
    window.sale_origin_identify_button.setObjectName("toolbarSecondaryButton")
    ...
    sale_form.addWidget(window.sale_origin_value_label, 2, 1, 1, 3)
    sale_form.addWidget(window.sale_origin_identify_button, 2, 4)
    ...
    window.sale_origin_identify_button.clicked.connect(window._handle_sale_origin_identify)
