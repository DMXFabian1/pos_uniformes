...
def build_inventory_tab(window: "MainWindow") -> QWidget:
    ...
    filters_row.addWidget(window.inventory_category_filter_combo, 1, 1)
    filters_row.addWidget(window.inventory_brand_filter_combo, 1, 2)
    filters_row.addWidget(window.inventory_school_filter_combo, 1, 3)
    filters_row.addWidget(window.inventory_type_filter_combo, 1, 4)
    filters_row.addWidget(window.inventory_piece_filter_combo, 1, 5)
    filters_row.addWidget(window.inventory_size_filter_combo, 1, 6)
    ...
    filters_row.addWidget(window.inventory_duplicate_filter_combo, 2, 5, 1, 2)
