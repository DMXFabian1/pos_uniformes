...
def build_products_tab(window: "MainWindow") -> QWidget:
    ...
    filters_grid.addWidget(category_label, 1, 0)
    filters_grid.addWidget(window.catalog_category_filter_combo, 1, 1)
    filters_grid.addWidget(brand_label, 1, 2)
    filters_grid.addWidget(window.catalog_brand_filter_combo, 1, 3)
    filters_grid.addWidget(school_label, 1, 4)
    filters_grid.addWidget(window.catalog_school_filter_combo, 1, 5)
    filters_grid.addWidget(type_label, 1, 6)
    filters_grid.addWidget(window.catalog_type_filter_combo, 1, 7)
    filters_grid.addWidget(piece_label, 2, 0)
    filters_grid.addWidget(window.catalog_piece_filter_combo, 2, 1)
    filters_grid.addWidget(size_label, 2, 2)
    filters_grid.addWidget(window.catalog_size_filter_combo, 2, 3)
    filters_grid.addWidget(color_label, 2, 4)
    filters_grid.addWidget(window.catalog_color_filter_combo, 2, 5)
    filters_grid.addWidget(status_label, 2, 6)
    filters_grid.addWidget(window.catalog_status_filter_combo, 2, 7)
    filters_grid.addWidget(stock_label, 3, 0)
    filters_grid.addWidget(window.catalog_stock_filter_combo, 3, 1)
    filters_grid.addWidget(layaway_label, 3, 2)
    filters_grid.addWidget(window.catalog_layaway_filter_combo, 3, 3)
    filters_grid.addWidget(origin_label, 3, 4)
    filters_grid.addWidget(window.catalog_origin_filter_combo, 3, 5)
    filters_grid.addWidget(duplicate_label, 3, 6)
    filters_grid.addWidget(window.catalog_duplicate_filter_combo, 3, 7)
