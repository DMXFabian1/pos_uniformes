...
def build_quotes_tab(window: "MainWindow") -> QWidget:
    ...
    window.quote_client_combo.setEnabled(False)
    window.quote_client_combo.setToolTip("Cliente asignado por escaneo QR. No se puede cambiar manualmente.")
    ...
    quote_form.addWidget(form_label("Cliente (QR)"), 0, 3)
    ...
    window.quote_state_combo.addItem("Vencidos", "VENCIDO")
