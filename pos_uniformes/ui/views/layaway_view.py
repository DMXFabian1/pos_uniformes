...
def build_layaway_tab(window: "MainWindow") -> QWidget:
    ...
    actions_row.addWidget(window.layaway_void_payment_button)
    actions_row.addWidget(window.layaway_edit_button)
    ...
    window.layaway_void_payment_button.clicked.connect(window._handle_void_layaway_payment)
    window.layaway_edit_button.clicked.connect(window._handle_edit_layaway)
