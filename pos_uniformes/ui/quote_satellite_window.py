...
class QuoteSatelliteWindow(QMainWindow):
    ...
    def _build_guided_page(self) -> QWidget:
        ...
        # Columna izquierda: pasos scrollables
        steps_scroll = QScrollArea()
        self.guided_page_scroll = steps_scroll
        steps_scroll.setObjectName("guidedStepsScroll")
        steps_scroll.setWidgetResizable(True)
        steps_scroll.setFrameShape(QFrame.Shape.NoFrame)
        steps_scroll.viewport().setObjectName("guidedStepsViewport")

        steps_container = QWidget()
        steps_container.setObjectName("guidedStepsContent")
        steps_container.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        steps_cl = QVBoxLayout()
        steps_cl.setContentsMargins(0, 0, 6, 0)
        steps_cl.setSpacing(0)
        steps_cl.addWidget(self._build_guided_steps_card())
        steps_cl.addSpacing(24)
        steps_container.setLayout(steps_cl)
        steps_scroll.setWidget(steps_container)

        # Columna derecha: detalle fijo
        detail_card = self._build_guided_detail_card()

        page_layout.addWidget(steps_scroll, 5)
        page_layout.addWidget(detail_card, 3)
    ...
    def _build_guided_steps_card(self) -> QFrame:
        ...
        def _step_section(parent_name: str) -> tuple[QFrame, QVBoxLayout]:
            sec = QFrame()
            sec.setObjectName(parent_name)
            sec.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
            lay = QVBoxLayout()
        ...
        # Paso 1 — Ruta
        mode_sec, mode_lay = _step_section("guidedStepSection")
        ...
        mode_lay.addLayout(self.guided_mode_row)
        mode_sec.setLayout(mode_lay)
        steps_layout.addWidget(mode_sec)

        # Paso 2 — Nivel
        self.guided_level_section, level_lay = _step_section("guidedStepSection")
        ...
        level_lay.addWidget(level_title)
        level_lay.addWidget(level_hint)
        level_lay.addLayout(self.guided_level_grid)
        self.guided_level_section.setLayout(level_lay)
        steps_layout.addWidget(self.guided_level_section)

        # Paso 3 — Escuela
        self.guided_school_section, school_lay = _step_section("guidedStepSection")
        ...
        school_lay.addWidget(school_title)
        school_lay.addWidget(school_hint)
        school_lay.addWidget(school_scroll)
        self.guided_school_section.setLayout(school_lay)
        steps_layout.addWidget(self.guided_school_section, 1)

        # Paso 4 — Tipo de uniforme / línea
        self.guided_gender_section, gender_lay = _step_section("guidedStepSection")
        ...
        gender_lay.addWidget(self.guided_gender_title_label)
        gender_lay.addWidget(self.guided_gender_hint_label)
        gender_lay.addLayout(self.guided_gender_row)
        self.guided_gender_section.setLayout(gender_lay)
        steps_layout.addWidget(self.guided_gender_section)

        # Paso 5a — Perfil oficial
        self.guided_profile_section, profile_lay = _step_section("guidedStepSection")
        ...
        profile_lay.addWidget(self.guided_profile_title_label)
        profile_lay.addWidget(self.guided_profile_hint_label)
        profile_lay.addLayout(self.guided_profile_row)
        self.guided_profile_section.setLayout(profile_lay)
        steps_layout.addWidget(self.guided_profile_section)

        # Paso 5b — Grupo (básicos/extras)
        self.guided_bucket_section, bucket_lay = _step_section("guidedStepSection")
        ...
        bucket_lay.addWidget(self.guided_bucket_title_label)
        bucket_lay.addWidget(self.guided_bucket_hint_label)
        bucket_lay.addLayout(self.guided_bucket_row)
        self.guided_bucket_section.setLayout(bucket_lay)
        steps_layout.addWidget(self.guided_bucket_section)

        # Paso 6 — Tipo de pieza
        self.guided_piece_section, piece_lay = _step_section("guidedStepSection")
        ...
        piece_lay.addWidget(self.guided_piece_title_label)
        piece_lay.addWidget(self.guided_piece_hint_label)
        piece_lay.addLayout(self.guided_piece_groups_layout)
        self.guided_piece_section.setLayout(piece_lay)
        steps_layout.addWidget(self.guided_piece_section)

        # Paso 7 — Modelos sugeridos
        self.guided_products_section, products_lay = _step_section("guidedStepSection")
        ...
        products_lay.addWidget(self.guided_products_title_label)
        products_lay.addWidget(self.guided_products_hint_label)
        products_lay.addWidget(self.guided_empty_label)
        products_lay.addWidget(self.guided_product_scroll, 1)
        self.guided_products_section.setLayout(products_lay)
    ...
    def _build_guided_detail_card(self) -> QFrame:
        """Construye el panel fijo de producto seleccionado (ícono + variantes + acciones)."""
        detail_box = QFrame()
        detail_box.setObjectName("guidedDetailCard")
        ...
        # Header: ícono + texto
        detail_header = QHBoxLayout()
        detail_header.setSpacing(14)
        self.guided_visual_icon_label.setFixedSize(96, 96)
        detail_header.addWidget(self.guided_visual_icon_label, 0, Qt.AlignmentFlag.AlignTop)
        detail_text_layout = QVBoxLayout()
        detail_text_layout.setSpacing(6)
        ...
        detail_divider = QFrame()
        detail_divider.setObjectName("guidedDetailDivider")
        detail_divider.setFrameShape(QFrame.Shape.HLine)
        ...
        qty_label.setObjectName("satFieldLabel")
        self.guided_add_button.setObjectName("addToCartButton")
        self.guided_add_button.setMinimumHeight(48)
        ...
        detail_actions.addWidget(qty_label)
        ...
        detail_layout.addWidget(detail_divider)
        detail_layout.addWidget(self.guided_variant_section, 1)
