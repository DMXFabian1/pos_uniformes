...
DEFAULT_QUOTE_TERMS_LINES = (
    ...
    "",
    "3. Promociones",
    "Por la alta demanda previa al inicio de clases, los padres que compren en junio de 2026 recibiran un descuento al registrarse en Maximoda. Valido solo del 1 al 30 de junio, sujeto a disponibilidad.",
    "",
